...
class ThreadBinding {
  ...
  private static final class LazyStorage {
    static final ThreadStorage storage;
    ...
    private static ThreadStorage createStorage(
      ...
      try {
        ...
        // ThreadContext
        return clazz.asSubclass(ThreadStorage.class).getConstructor().newInstance();
      } catch (ClassNotFoundException e) {
        deferredStorageFailure.set(e);
        return new DefaultThreadStorage();
      } catch (Exception e) {
